import { AlignCenterOutlined, AlignLeftOutlined, AlignRightOutlined, BoldOutlined, FileImageOutlined, ItalicOutlined, PicCenterOutlined, RotateLeftOutlined, RotateRightOutlined, UnderlineOutlined } from '@ant-design/icons';
...
const EditorMenu = ({ editor, displayImageMenu }: EditorMenuProps) => {
    ...
    useEffect(() => {
        ...
        const hasImage = editor?.getJSON()?.content?.some(node => node.type === 'image') || false;
    ...
    return (
        <div>
            <div className="menu">
                ...
                <div
                    onMouseLeave={() => setImageModal(false)}
                >
                    {displayImageMenu &&
                        <button
